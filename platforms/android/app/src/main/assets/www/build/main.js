        ...
        this.geocoder.geocode({ 'placeId': item.place_id }, function (results, status) {
            if (status === 'OK' && results[0]) {
                ...
                _this.nativeGeocoder.reverseGeocode(results[0].geometry.location.lat(), results[0].geometry.location.lng(), options)
                    ...
                    _this.address.cep = result2[0]['postalCode'];
                ...
                _this.address = [];
                _this.address.endereco = results[0].address_components[0].long_name;
                _this.address.bairro = results[0].address_components[1].long_name;
                _this.address.cidade = results[0].address_components[2].long_name;
                _this.address.estado = results[0].address_components[3].long_name;
                            ...
                            _this.zone.run(function () {
                                ...
                                if (results[0] != null) {
                                    ...
                                    */
                                    ...
                                    ///this.address.endereco = results[0].address_components[1].long_name;
                                    _this.address = [];
                                    _this.address.endereco = results[0].address_components[1].long_name;
                                    _this.address.bairro = results[0].address_components[2].long_name;
                                    _this.address.cidade = results[0].address_components[3].long_name;
                                    _this.address.estado = results[0].address_components[4].long_name;
                                    _this.address.cep = results[0].address_components[6].long_name;
                                    //console.log(this.address);
                                }
                            });
                        }
