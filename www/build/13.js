...
var AddressListPageModule = /** @class */ (function () {
    ...
    AddressListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__address_list__["a" /* AddressListPage */]), __WEBPACK_IMPORTED_MODULE_3__app_pipes_module__["a" /* PipesModule */]],
...
var AddressListPage = /** @class */ (function () {
    function AddressListPage(af, db, navCtrl, navParams, alertCtrl, authService, modalCtrl, fbs) {
        ...
        if (this.af.auth.currentUser) {
            this.db
                .list("/users/" + this.af.auth.currentUser.uid + "/address").snapshotChanges().pipe(Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["map"])(function (changes) { return changes.map(function (c) { return (__assign({ $key: c.payload.key }, c.payload.val())); }); })).subscribe(function (res) {
                //console.log(res.length);
                if (res.length == 0) {
                    //console.log("Nada");
                    var profileModal = _this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_8__add_endereco_add_endereco__["a" /* AddEnderecoPage */]);
                    ...
                    profileModal.onDidDismiss(function (data) {
                        ...
                        if (data.data == 1) {
                            ...
                            _this.orderDetails.shippingAddress = data.data;
                    ...
                    _this.addressList = output;
                    _this.orderDetails.shippingAddress = output;
                    /*grandTotal
                    subTotal
                    totalVat
                    dataPedidoAgendado
    ...
    AddressListPage.prototype.insertCep = function () {
        var _this = this;
        var profileModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_7__insert_cep_insert_cep__["a" /* InsertCepPage */], { modalId: 1 });
        profileModal.present();
        profileModal.onDidDismiss(function (data) {
            //console.log(data.cep);
            if (data.cep != 0) {
                _this.getDataGoogleMaps(data.cep);
            }
        });
    };
    AddressListPage.prototype.getDataGoogleMaps = function (cep) {
        var _this = this;
    ...
    AddressListPage.prototype.checkOut = function () {
        ...
        if (this.orderDetails.shippingAddress) {
            //console.log(this.orderDetails);
            this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_6__checkout_checkout__["a" /* CheckoutPage */], {
    ...
    AddressListPage.prototype.addressOK = function () {
