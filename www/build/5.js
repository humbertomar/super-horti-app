...
var SettingsModule = /** @class */ (function () {
    ...
    SettingsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__settings__["a" /* Settings */]), __WEBPACK_IMPORTED_MODULE_3__app_pipes_module__["a" /* PipesModule */]],
...
var Settings = /** @class */ (function () {
    function Settings(af, db, toastCtrl, loadingCtrl, navCtrl, platform, events, modalCtrl, alertCtrl) {
        this.af = af;
        this.db = db;
        ...
        this.file = {};
        this.storageRef = __WEBPACK_IMPORTED_MODULE_4_firebase_app__["storage"]();
        this.addressList = [];
        this.address = {};
    }
        ...
        if (this.af.auth.currentUser) {
            this.db.object("/users/" + this.af.auth.currentUser.uid).valueChanges().subscribe(function (res) {
                ...
                if (res) {
                    ...
                    _this.user.image = "assets/img/profile.jpg";
                    _this.url = "assets/img/profile.jpg";
                }
            });
        }
    ...
    Settings.prototype.readUrl = function (event) {
        ...
        loader.present();
        this.storageRef.ref().child("profile/" + this.file.name).put(this.file, metadata).then(function (res) {
    ...
    Settings.prototype.onSubmit = function (user) {
        ...
        if (this.af.auth.currentUser) {
            this.db.object("/users/" + this.af.auth.currentUser.uid).update({
                ...
                .then(function () {
                _this.createToaster("Informações atualizadas com sucesso", 3000);
                _this.events.publish("imageUrl", _this.user);
            });
        }
    };
    Settings.prototype.onSubmit2 = function (address) {
        var _this = this;
    ...
    Settings.prototype.deleteAddress = function (key) {
        var _this = this;
            ...
            buttons: [
                {
                    ...
                    handler: function (data) {
                        _this.db.list("/users/" + _this.af.auth.currentUser.uid + "/address").remove(key);
                    }
                }, {
                    text: "Cancelar",
                    role: 'cancel',
