...
var HomePageModule = /** @class */ (function () {
    ...
    HomePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__home__["a" /* HomePage */]), __WEBPACK_IMPORTED_MODULE_3__app_pipes_module__["a" /* PipesModule */]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_firebase_service_firebase_service__ = __webpack_require__(434);
...
var HomePage = /** @class */ (function () {
    function HomePage(af, db, navCtrl, loadingCtrl, authService, fbs) {
        var _this = this;
        this.af = af;
        this.db = db;
    ...
    HomePage.prototype.getDataSlider = function () {
        var _this = this;
        this.authService.getData('sliders').then(function (result) {
            //console.log(result);
            _this.dataSetSlider = result;
            if (_this.dataSetSlider) {
    ...
    HomePage.prototype.getDataCategory = function () {
        var _this = this;
        this.authService.getData('category')
            .then(function (result) {
            //console.log(result);
            _this.dataSetCategory = result;
        }, function (err) {
            console.log(err);
        });
    };
    HomePage.prototype.getAddressUser = function () {
        var _this = this;
        if (localStorage.getItem("uid")) {
            this.db
                .list("/users/" + localStorage.getItem("uid") + "/address").snapshotChanges().pipe(Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["map"])(function (changes) { return changes.map(function (c) { return (__assign({ $key: c.payload.key }, c.payload.val())); }); })).subscribe(function (res) {
