...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__product_details__ = __webpack_require__(787);
...
var ProductDetailsPageModule = /** @class */ (function () {
    ...
    ProductDetailsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__product_details__["a" /* ProductDetailsPage */]), __WEBPACK_IMPORTED_MODULE_3__app_pipes_module__["a" /* PipesModule */]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_cart_service__ = __webpack_require__(444);
...
var ProductDetailsPage = /** @class */ (function () {
    function ProductDetailsPage(navCtrl, af, db, navParams, cartService, alertCtrl, loadingCtrl, toastCtrl, authService, viewCtrl) {
    ...
    ProductDetailsPage.prototype.getDataProductID = function () {
        var _this = this;
        this.authService.getData('productID/' + this.id)
            ...
            //console.log("cart: "+JSON.stringify(this.Cart));
            //console.log(this.Cart);
            _this.menuItems.id = result[0].id;
            _this.menuItems.name = result[0].name;
            _this.menuItems.image = result[0].image;
            _this.menuItems.description = result[0].description;
            _this.menuItems.price = result[0].price;
            //console.log(this.menuItems);
            _this.cart.name = result[0].name;
            _this.cart.itemId = _this.id;
            _this.cart.image = result[0].image;
            _this.cart.price = result[0].price;
            if (_this.Cart == null || _this.Cart.length == 0) {
                //console.log(result);
                _this.cart.itemQunatity = _this.count;
                //console.log(this.cart);
            }
            else {
                for (var i = 0; i < _this.Cart.length; i++) {
                    //console.log(this.Cart[i]);
                    if (_this.Cart[i].item.itemId == result[0].id) {
                        //console.log(result);
                        _this.count = _this.Cart[i].item.itemQunatity;
                        //console.log(this.cart);
                    }
    ...
    ProductDetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-product-details",template:/*ion-inline-start:"/Users/Shared/projects/super-horti-app/src/pages/product-details/product-details.html"*/'<ion-header>\n    <ion-navbar>\n        <ion-title class="title">Detalhe do Produto</ion-title>\n        <ion-buttons end>\n            <button ion-button icon-only color="royal" (click)="navcart()" class="header-btn-cart">\n                <ion-icon name="cart"></ion-icon>\n                <ion-badge class="carts" item-right color="danger">{{noOfItems}}</ion-badge>\n            </button>\n        </ion-buttons>\n    </ion-navbar>\n</ion-header>\n\n<ion-content class="item-page">\n    <ion-row class="productImage">\n        <img class="displayed" *ngIf="menuItems.image != \'Nenhum arquivo foi selecionado.\'" src=\'https://superhorti.com.br/appAdmin/{{menuItems.image}}\' alt={{menuItems.name}} />\n        <img class="displayed" *ngIf="menuItems.image == \'Nenhum arquivo foi selecionado.\'" src=\'https://superhorti.com.br/ws/assets/imgs/logo-sh.png\' alt={{menuItems.name}} />\n    </ion-row>\n\n    <div class="card-title" *ngFor="let data of Cart" color="primary">\n        <span *ngIf="data.item.itemId == menuItems.id">Este Produto já está no seu carrinho!</span>\n    </div>\n\n    <ion-row>\n        <ion-col col-6>\n            <div class="center count">\n                <span class="item-count" (click)="removeQuantity()">\n                    -\n                </span>\n                <span class="item-count show-count">\n                    {{count}}\n                </span>\n                <span class="item-count" (click)="addQuantity()">\n                    +\n                </span>\n            </div>\n        </ion-col>\n\n        <ion-col col-6>\n            <div class="center">\n                <a (click)="addToCart()" ion-button round icon-left class="btn-add-to-cart">\n                    <ion-icon name="md-add-circle"></ion-icon>\n                    &nbsp; ADICIONAR\n                </a>\n            </div>\n        </ion-col>\n    </ion-row>\n        \n    <ion-list-header class="size-list-header" text-center>\n        <p text-wrap class="fontsize01"><strong>{{ menuItems.name }}</strong></p>\n        <p text-wrap class="fontsize01">Preço {{ menuItems.price | currency:\'BRL\':true:\'1.2-2\' }}</p>\n        <p text-wrap class="fontsize01"><strong>Descrição:</strong> {{ menuItems.description }}</p>\n        <p text-wrap class="fontsize02">Adicionar ao Carrinho</p>\n        <p text-wrap class="fontsize02"><strong>{{count}} X {{ menuItems.name }}</strong></p>\n        <p text-wrap class="fontsize01"><strong>Total {{ count * menuItems.price | currency:\'BRL\':true:\'1.2-2\' }}</strong></p>\n    </ion-list-header>   \n\n    <ion-row class="button-fixed">\n        <ion-col col-6>\n            <div class="center">\n                <a (click)="navcart()" ion-button round icon-left class="btn-add-to-cart">\n                    <ion-icon name="cart"></ion-icon>\n                    &nbsp; CHECKOUT\n                </a>\n            </div>\n        </ion-col>\n        <ion-col col-6>\n            <div class="center">\n                <a (click)="home()" ion-button round icon-left class="btn-add-to-cart">\n                    <ion-icon name="basket"></ion-icon>\n                    &nbsp; COMPRAR +\n                </a>\n            </div>\n        </ion-col>\n    </ion-row>\n\n</ion-content>\n\n<ion-footer class="ion-no-border">\n    <ion-toolbar>\n        <p style="font-size: 12px; text-align: center;" ion-text color="light">\n            Super Horti Comércio de Verduras e Legumes LTDA</p>\n    </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/Users/Shared/projects/super-horti-app/src/pages/product-details/product-details.html"*/
        }),
