...
var CartPageModule = /** @class */ (function () {
    ...
    CartPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__cart__["a" /* CartPage */]), __WEBPACK_IMPORTED_MODULE_3__app_pipes_module__["a" /* PipesModule */]],
...
var PipesModule = /** @class */ (function () {
    ...
    PipesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__["a" /* TranslateModule */]],
            exports: [__WEBPACK_IMPORTED_MODULE_2__ngx_translate_core__["a" /* TranslateModule */], __WEBPACK_IMPORTED_MODULE_1__app_pipe__["a" /* AppPipe */]]
        })
    ], PipesModule);
    return PipesModule;
}());
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global) {/* unused harmony export ɵa */
...
/* unused harmony export TranslateFakeLoader */
/* unused harmony export USE_STORE */
/* unused harmony export USE_DEFAULT_LANG */
/* unused harmony export TranslateService */
/* unused harmony export MissingTranslationHandler */
/* unused harmony export FakeMissingTranslationHandler */
/* unused harmony export TranslateParser */
/* unused harmony export TranslateDefaultParser */
/* unused harmony export TranslateCompiler */
/* unused harmony export TranslateFakeCompiler */
...
var CartPage = /** @class */ (function () {
    function CartPage(af, db, navCtrl, alertCtrl, loadingCtrl, toastCtrl, authService, modalCtrl, fbs) {
        this.af = af;
        this.db = db;
        ...
        this.data_pedido = __WEBPACK_IMPORTED_MODULE_4_moment__().format("YYYY-MM-DD");
        var diaPedido = parseInt(__WEBPACK_IMPORTED_MODULE_4_moment__().format("d"));
        var horaPedido = parseInt(__WEBPACK_IMPORTED_MODULE_4_moment__().format("HH"));
        //dom: 0, seg: 1, ter: 2, qua: 3, qui: 4, sex: 5, sab: 6
        if (diaPedido == 0 && horaPedido <= this.horario_maximo_pedidos) { //domingo até 20:00
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(1, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(1, 'day').format("dddd"); //entrega segunda
        }
        else if (diaPedido == 0 && horaPedido > this.horario_maximo_pedidos) { //domingo depois das 20:00
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(2, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(2, 'day').format("dddd"); //entrega terça
        }
        else if (diaPedido == 1 && horaPedido <= this.horario_maximo_pedidos) { //segunda até 20:00
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(1, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(1, 'day').format("dddd"); //entrega terça
        }
        else if (diaPedido == 1 && horaPedido > this.horario_maximo_pedidos) { //segunda depois das 20:00
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(3, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(3, 'day').format("dddd"); //entrega quinta
        }
        else if (diaPedido == 2 && horaPedido <= this.horario_maximo_pedidos) { //terça até 20:00
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(2, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(2, 'day').format("dddd"); //entrega quinta
        }
            ...
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(1, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(1, 'day').format("dddd"); //entrega quinta
        }
        else if (diaPedido == 3 && horaPedido > this.horario_maximo_pedidos) { //quarta depois das 20:00
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(2, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(2, 'day').format("dddd"); //entrega sexta
        }
        else if (diaPedido == 4 && horaPedido <= this.horario_maximo_pedidos) { //quinta até 20:00
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(1, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(1, 'day').format("dddd"); //entrega sexta
        }
        else if (diaPedido == 4 && horaPedido > this.horario_maximo_pedidos) { //quinta depois das 20:00
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(4, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(4, 'day').format("dddd"); //entrega segunda
        }
        else if (diaPedido == 5 && horaPedido <= this.horario_maximo_pedidos) { //sexta até 20:00
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(3, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(3, 'day').format("dddd"); //entrega segunda
        }
            ...
            this.data_entrega = __WEBPACK_IMPORTED_MODULE_4_moment__().add(2, 'day').format("YYYY-MM-DD");
            this.dia_semana = __WEBPACK_IMPORTED_MODULE_4_moment__().add(2, 'day').format("dddd"); //entrega segunda
        }
    ...
    CartPage.prototype.ionViewWillEnter = function () {
        ...
        if (localStorage.getItem("uid")) {
            this.db.list("/users/" + this.af.auth.currentUser.uid + "/address").snapshotChanges().pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["map"])(function (changes) {
                return changes.map(function (c) { return (__assign({ $key: c.payload.key }, c.payload.val())); });
            })).subscribe(function (res) {
                console.log(res);
                if (res.length > 0) {
                    _this.addressList = res;
                    _this.address.$key = localStorage.getItem('keyAddress');
                }
            ...
            this.authService.getData('settings').then(function (data) {
                _this.settings = data;
                if (_this.version != _this.settings[0].versao) {
                    ...
                    alert.present();
                    _this.bloquear_botao = true;
                }
                else {
                    _this.bloquear_botao = false;
                }
                _this.settings.forEach(function (elemento) {
                    ...
                    //console.log(localStorage.getItem("uid"));
                    if (localStorage.getItem("uid")) {
                        _this.db.list("/users/" + localStorage.getItem("uid") + "/address").snapshotChanges().pipe(Object(__WEBPACK_IMPORTED_MODULE_6_rxjs_operators__["map"])(function (changes) { return changes.map(function (c) { return (__assign({ $key: c.payload.key }, c.payload.val())); }); })).subscribe(function (res) {
                            if (res.length > 0) {
                                if (localStorage.getItem('frete')) {
                                    _this.ft = localStorage.getItem('frete');
                                }
                                else {
                                    _this.ft = 0;
                                }
                                _this.converterFrete(_this.ft);
                                _this.botaoRecalcularFrete = false;
                            }
                            else {
                                //console.log("Nada!");
                                if (localStorage.getItem('cep')) {
                                    _this.botaoRecalcularFrete = true;
                                    if (localStorage.getItem('frete')) {
                                        _this.cep = localStorage.getItem('cep');
                                        _this.ft = localStorage.getItem('frete');
                                    }
                                    else {
                                        _this.ft = 0;
    ...
    CartPage.prototype.addressUser = function (event) {
        //console.log(event);
        var _this = this;
        //console.log(localStorage.getItem("uid"));
        if (localStorage.getItem("uid")) {
            var subscribe_1 = this.fbs.get("/users/" + this.af.auth.currentUser.uid + "/address/", event).subscribe(function (c) {
                subscribe_1.unsubscribe();
                var endereco = c;
                //console.log(endereco.cep);
                //console.log(endereco);
                _this.cep = endereco.cep;
                _this.converterFrete(endereco.frete);
                _this.authService.getData('settings').then(function (data) {
                    _this.settings = data;
    ...
    CartPage.prototype.checarValorProdutos = function () {
        var _this = this;
        ...
        var _loop_1 = function (i) {
            ...
            this_1.authService.getData('productID/' + this_1.Cart[i].item.itemId).then(function (data) {
                _this.settings = data;
                //console.log(Number(this.settings[0].price).toFixed(2));
                //console.log(Number(this.Cart[i].item.price).toFixed(2));
                if (Number(_this.settings[0].price).toFixed(2) != Number(_this.Cart[i].item.price).toFixed(2)) {
                    ...
                    _this.Cart[i].itemTotalPrice = _this.settings[0].price * _this.Cart[i].item.itemQunatity;
                    _this.Cart[i].item.price = _this.settings[0].price;
                    localStorage.setItem("Cart", JSON.stringify(_this.Cart));
                    _this.callFunction();
                    if ((_this.Cart.length - 1) == i) {
                        var alert = _this.alertCtrl.create({
                            title: 'Atenção',
    ...
    CartPage.prototype.insertCep = function () {
        var profileModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_8__google_maps_geolocalizacao_google_maps_geolocalizacao__["a" /* GoogleMapsGeolocalizacaoPage */]);
        profileModal.present();
    ...
    CartPage.prototype.converterFrete = function (ft) {
        //console.log(ft);
        var _this = this;
        this.authService.getData('settings').then(function (data) {
            _this.settings = data;
            ...
            _this.settings.forEach(function (elemento) {
                ...
                if (ft == 0 || ft == 7) {
                    _this.freteFinal = elemento.frete_5;
                    //console.log(elemento.frete_5);
                }
                else if (ft == 15) {
                    _this.freteFinal = elemento.frete_10;
                    //console.log(elemento.frete_10);
                    //console.log(elemento.frete_25);
                }
                else { //25
                    _this.freteFinal = elemento.frete_30;
                    //console.log(elemento.frete_30);
                }
                localStorage.setItem('freteFinal', _this.freteFinal);
                _this.frete = _this.freteFinal;
                console.log('frete cad: ' + ft);
                console.log('frete conv: ' + _this.frete);
                _this.callFunction();
            });
        }, function (err) {
            console.log(err);
    ...
    CartPage.prototype.getDataGoogleMaps = function (cep, bairro, endereco) {
        var _this = this;
        if (cep != 1) {
            this.authService.getData('googleMaps/' + cep).then(function (result) {
                ...
                if ((_this.dataSetGoogleMaps != 'Digite um CEP válido') && (_this.dataSetGoogleMaps != 'Não fazemos entrega nessa região!')) {
                    ...
                    alert.present();
                    _this.cep = cep;
                    _this.ft = JSON.stringify(_this.dataSetGoogleMaps);
                    _this.converterFrete(_this.ft);
                    ...
                    _this.frete = localStorage.getItem('freteFinal');
                }
                else {
                    var alert = _this.alertCtrl.create({
    ...
    CartPage.prototype.openCalendar = function () {
        ...
        myCalendar.onDidDismiss(function (date, type) {
            ...
            if (date) {
                ...
                if (resultado[0] == 'Sun' || resultado[0] == 'Sat' || resultado[0] == 'Wed') {
                    ...
                    if (resultado[0] == 'Mon') {
                        _this.dia_semana = 'segunda-feira';
                    }
                    else if (resultado[0] == 'Tue') {
                        _this.dia_semana = 'terça-feira';
                    }
                    else if (resultado[0] == 'Thu') {
                        _this.dia_semana = 'quinta-feira';
                    }
                    else if (resultado[0] == 'Fri') {
                        _this.dia_semana = 'sexta-feira';
                    }
                    //console.log(this.diaSemana);
                    _this.pedidoAgendado = "1";
                    _this.dataEntregaAgendado = date.string;
                    _this.diaSemanaAgendado = _this.dia_semana;
                ...
                _this.pedidoAgendado = "0";
            }
        });
    };
    //apenas para funcionar o elemento
    CartPage.prototype.segmentChanged = function ($event) {
    ...
    CartPage.prototype.nav2 = function () {
        ...
        if (this.totalItems < 10) {
            ...
            if (!localStorage.getItem("uid")) {
                ...
                if (this.pedidoAgendado != "1") {
                    ...
                    this.dataEntrega = this.data_entrega;
                    this.diaSemana = this.dia_semana;
                    var dataEntrega = this.dataEntrega.split('-');
                                ...
                                buttons: [
                                    {
                                        ...
                                        handler: function (data) {
                                            _this.navCtrl.push("AddressListPage", {
                                                grandTotal: _this.GrandTotal,
                                                subTotal: _this.subTotal,
                                                totalVat: _this.total,
                                                dataPedidoAgendado: _this.data_entrega,
                                                diaSemana: _this.diaSemana,
                                                pedidoAgendado: _this.pedidoAgendado,
                    ...
                    if (this.totalItems < 10) {
                        ...
                        var dataEntrega = this.dataEntregaAgendado.split('-');
                        var alert = this.alertCtrl.create({
                            title: "Finalizar o pedido agora?",
                            ...
                            buttons: [
                                {
                                    ...
                                    handler: function (data) {
                                        _this.navCtrl.push("AddressListPage", {
                                            ...
                                            subTotal: _this.subTotal,
                                            totalVat: _this.total,
                                            dataPedidoAgendado: _this.dataEntregaAgendado,
                                            diaSemana: _this.diaSemanaAgendado,
                                            pedidoAgendado: _this.pedidoAgendado,
                                            totalItems: _this.totalItems
                                        });
                                    }
    ...
    CartPage.prototype.nav3 = function () {
        var alert = this.alertCtrl.create({
            title: "Atenção!",
    ...
    CartPage.prototype.home = function () {
        this.navCtrl.setRoot("HomePage");
    };
