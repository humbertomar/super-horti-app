...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__thankyou__ = __webpack_require__(793);
...
var ThankyouPageModule = /** @class */ (function () {
    ...
    ThankyouPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__thankyou__["a" /* ThankyouPage */]), __WEBPACK_IMPORTED_MODULE_3__app_pipes_module__["a" /* PipesModule */]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_social_sharing__ = __webpack_require__(166);
...
var ThankyouPage = /** @class */ (function () {
    function ThankyouPage(navCtrl, navParams, socialSharing, alertCtrl, authService, loadingCtrl) {
        var _this = this;
    ...
    ThankyouPage.prototype.getDataGoogleMaps = function (endereco) {
        ...
        loader.present().then(function () {
            _this.authService.getData('getGeoCode/' + endereco).then(function (result) {
                _this.gps = result;
                _this.latitude = _this.gps.latitude;
                _this.longitude = _this.gps.longitude;
                //console.log(result);
                loader.dismiss();
            }, function (err) {
                console.log(err);
    ...
    ThankyouPage.prototype.onClick = function () {
        //console.log(this.latitude+" | "+this.longitude)
        var _this = this;
        if (this.latitude != undefined || this.longitude != undefined) {
            this.socialSharing.shareViaWhatsAppToReceiver('5562993495445', 'Cliente: ' + this.nome + '. Pedido: ' + this.numPedido, null, 'https://maps.google.com/maps?q=' + this.latitude + '%2C' + this.longitude + '&z=17&hl=pt-BR').then(function (result) {
                ///console.log(result);
                _this.showAlert('A localização do endereço para entrega foi enviado com sucesso!');
            }).catch(function (error) {
                //console.log('Erro ao enviar a localização: ' + JSON.stringify(error));
                _this.showAlert('Erro ao enviar sua localização do endereço para entrega!');
            });
        }
        else {
    ...
    ThankyouPage.prototype.showAlert = function (message) {
    ...
    ThankyouPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-thankyou",template:/*ion-inline-start:"/Users/Shared/projects/super-horti-app/src/pages/thankyou/thankyou.html"*/'<ion-header class="ion-no-border">\n    <ion-toolbar>\n      <ion-buttons left>\n        <button color="light" ion-button menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n      </ion-buttons>\n      <ion-title class="title">\n        SH Delivery\n      </ion-title>\n      <ion-buttons end>\n        \n      </ion-buttons>\n    </ion-toolbar>\n  </ion-header>\n\n<ion-content class="page-content">\n    <ion-row>\n        <ion-col col-12>\n            <div class="thanks">\n                <h2>Obrigado pela preferência!</h2>\n                <p>Seu pedido será entregue em breve!</p>\n                <p>Esse é o número do seu Pedido: {{ numPedido }}</p>\n            </div>\n        </ion-col>\n    </ion-row>\n    \n    <button ion-button class="continue-btn" (click)="home()" color="verde-escuro">Comprar mais!</button>\n\n    <br />\n    \n    <button ion-button class="continue-btn" (click)="onClick()" color="verde-escuro">Envie aqui o número do<br/>seu pedido e a sua localização!</button>\n\n</ion-content>\n\n<ion-footer class="ion-no-border">\n  <ion-toolbar>\n    <p style="font-size: 12px; text-align: center;" ion-text color="light">\n      Super Horti Comércio de Verduras e Legumes LTDA</p>\n  </ion-toolbar>\n</ion-footer>'/*ion-inline-end:"/Users/Shared/projects/super-horti-app/src/pages/thankyou/thankyou.html"*/
        }),
