...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__registration__ = __webpack_require__(791);
...
var RegistrationPageModule = /** @class */ (function () {
    ...
    RegistrationPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__registration__["a" /* RegistrationPage */]), __WEBPACK_IMPORTED_MODULE_3__app_pipes_module__["a" /* PipesModule */]],
...
var RegistrationPage = /** @class */ (function () {
    function RegistrationPage(navCtrl, events, fb, af, db, loadingCtrl, alertCtrl, platform) {
    ...
    RegistrationPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: "page-registration",template:/*ion-inline-start:"/Users/Shared/projects/super-horti-app/src/pages/registration/registration.html"*/'<ion-content padding class="transparent-header" [ngStyle]="{\'background-image\': \'url(\' + backgroundImage +\')\'}">\n\n    <div padding>\n\n        <form [formGroup]="registration" (ngSubmit)="onSubmit()">\n        \n            <ion-row>\n                <ion-col>\n        \n                    <ion-list inset class="no-border">\n        \n                        <img class="logo" src="assets/img/logo-2.png" />\n        \n                        <ion-item>\n                            <ion-input type="email" name="email" placeholder="Digite seu e-mail" id="email"\n                                formControlName="email" required></ion-input>\n                        </ion-item>\n        \n                        <ion-item>\n                            <ion-input type="password" name="password" placeholder="Digite uma senha" id="password"\n                                formControlName="password" required></ion-input>\n                        </ion-item>\n        \n                    </ion-list>\n        \n                </ion-col>\n            </ion-row>\n            \n            <ion-row>\n                <ion-col>\n                    <button class="login-btn" type="submit" [disabled]="!registration.valid" ion-button>CADASTRAR</button>\n                </ion-col>\n            </ion-row>\n        \n        </form>\n\n        <br>\n\n        <ion-row>\n            <ion-col col-12 text-center>\n                <button (click)="navLogin()" ion-button small color="energy">ENTRAR</button>\n            </ion-col>\n            <ion-col col-12 text-center>\n                <button (click)="back()" ion-button small color="dark">VOLTAR</button>\n            </ion-col>\n        </ion-row>\n\n    </div>\n</ion-content>'/*ion-inline-end:"/Users/Shared/projects/super-horti-app/src/pages/registration/registration.html"*/,
        }),
